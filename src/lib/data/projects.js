export const projects = [
  {
    ...
    review: {
      paragraphs: [
        "Working with Talha felt more like teaming up with a genuine collaborator than hiring a remote developer. He understood our mission and the impact we wanted to create from the first conversation.",
        "Every feature from donation tracking to volunteer coordination was carefully implemented. He helped us build a platform that truly serves our environmental mission."
      ],
      author: {
        avatar: "EY",
        name: "Emre Yilmaz",
        title: "Founder — DeliveTree"
      },
      tag: "✓ Verified review for DeliveTree"
    },
    nextProject: {
      id: "2",
      title: "SQAlify",
  ...
  },
  {
    id: "2",
    title: "SQAlify",
    website: "sqaquest.edu",
    type: "3D Educational Game",
    year: "2025",
    ...
    review: {
      paragraphs: [
        "Talha pushed the boundaries of what we thought was possible in educational game design. The mini-games feel intuitive and engaging — students learn SQA concepts without feeling overwhelmed.",
        "The gamified approach and level progression create an environment that's both productive and deeply engaging. Our test users consistently lose track of time because learning feels like play."
      ],
      author: {
        avatar: "MH",
        name: "Dr. Muhammad Hassan",
        title: "FYP Advisor — FAST NUCES"
      },
      tag: "✓ Verified review for SQAlify"
    },
    nextProject: {
      id: "3",
      title: "DocIntel",
  ...
  },
  {
    ...
    title: "DocIntel",
    website: "docintel.ai",
    type: "Contract Verification SaaS",
    year: "2025",
    ...
    review: {
      paragraphs: [
        "This tool is a lifesaver for freelancers. Talha built something that solves a real, painful problem — understanding legal jargon without a lawyer. It's fast, accurate, and incredibly easy to use.",
        "The layout is clean and the analysis is surprisingly detailed. It caught a non-compete clause I would have definitely missed. A must-have tool for independent contractors."
      ],
      author: {
        avatar: "MS",
        name: "Mike Stevens",
  ...
  },
  {
    id: "4",
    title: "Resume AI",
    website: "resumeai.net",
    type: "Career Automation Tool",
    year: "2025",
    ...
    review: {
      paragraphs: [
        "I was skeptical about AI resume tools, but this one is different. It doesn't just keywords stuff; it actually gives meaningful advice on structure and content.",
        "The interview practice feature is a game changer. It helped me prep for my actual technical rounds with confidence. A solid tool for anyone serious about their career search."
      ],
      author: {
        avatar: "JD",
        name: "John Doe",
...
export function getNextProjectId(currentId) {
