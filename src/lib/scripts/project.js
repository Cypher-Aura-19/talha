...
export function cleanupProject() {
  ...
  console.log('[Project Cleanup] Starting cleanup...');
  ...
  try {
    ...
    console.log('[Project Cleanup] Killing ScrollTriggers:', scrollTriggers.length);
    ...
    console.log('[Project Cleanup] Cleanup complete');
  } catch (error) {
    console.error('[Project Cleanup] Error during cleanup:', error);
  }
}
